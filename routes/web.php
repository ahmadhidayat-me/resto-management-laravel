...
// echo "<pre>";print_r($oldCart);echo"</pre>";exit;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth']], function () {
    Route::get('/', function () {
        ...
        ->name('admin.home')
        ->middleware('level.admin:owner');

    // User
    Route::group(['prefix' => 'user', 'middleware' => 'level.admin'], function () {
        Route::get('/', 'UserController@daftar')
            ->name('admin.user')
    ...
    Route::group(['prefix' => 'dapur', 'middleware' => 'level.admin:kasir'], function () {
        Route::get('/test', function () {
            $user = User::all()->toArray();
            echo "<pre>";
            print_r($user);
        ...
        Route::get('/', 'MasakanController@daftar')->name('dapur.masakan');
        Route::delete('/', 'MasakanController@delete');

        //Route::get('/add', 'MasakanController@add');
        Route::post('/add', 'MasakanController@save')->name('dapur.masakan.add');

        Route::get('/edit/{id}', 'MasakanController@edit')->name('dapur.masakan.edit');
        Route::post('/edit/{id}', 'MasakanController@update');
    });
    // End MAsakan
